...
[Backend part](https://github.com/MarkoKermi/hello-rails-back-end.git)
...
```sh
  git clone https://github.com/MarkoKermi/hello-rails-back-end.git
...
Feel free to check the [issues page](https://github.com/MarkoKermi/hello-rails-back-end/issues).
